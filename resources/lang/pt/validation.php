...
return [
    ...
    */
    'custom' => [
        ...
        'tickets_end' => [
            'min' => 'O campo Fim deve conter um valor superior ao do campo Início',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes' => [
        ...
        'release_title' => 'título de lançamento',
        'author' => 'autor',
        'text' => 'texto',
        'post_image' => 'imagem da noticía',
        ...
        'state_id' => 'estado',
        'city_id' => 'cidade',
        'company_name' => 'nome da compania',
        'contact_name' => 'nome do contato',
        'telephone1' => 'telefone',
        'resume_file' => 'currículo',
        'post_category_id' => 'categoria',
    ],
];