...
@section('content')
  <div class="container-fluid">
    @include('elements.admin.shared.header', [
      ...
      'breadcrumbs' => [
        ['title' => 'Licitações - Processos', 'url' => route('admin.b_trimestrals.index')],
        ['title' => $parent_page->title, 'url' => route('admin.b_trimestrals.edit', [$parent_page->id])],
        ['title' => 'Anexos', 'url' => route('admin.b_trimestrals.attachments.index', $parent_page->id)],
      ]
    ])
    <div class="ls-box-filter">
      {!!Form::open([
        'files' => true,
        'route' => ['admin.b_trimestrals.attachments.store', $parent_page->id],
        'method' => 'POST',
        'class' => 'ls-form ls-form-horizontal row'
      ])!!}
        {!!Form::hidden('btrimestral_id', $parent_page->id)!!}
        <fieldset>
              ...
              <td class="ls-txt-right ls-regroup">
                <div class="ls-dropdown ls-pos-right" data-ls-module="dropdown">
                  ...
                  <ul class="ls-dropdown-nav" aria-hidden="true">
                    <li>@include('elements.admin.shared.delete_button', ['route' => route('admin.b_trimestrals.attachments.destroy', [$parent_page->id, $attachment->id])])</li>
                  </ul>
                </div>
              </td>
            </tr>
