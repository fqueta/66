...
@section('content')
  <div class="container-fluid">
    @include('elements.admin.shared.header', [
      ...
      'breadcrumbs' => [
        ['title' => 'Licitações - Processos Trimestrais', 'url' => route('admin.b_trimestrals.index')],
      ]
    ])
    ...
    @include('elements.admin.shared.add_button', [
      'route' => route('admin.b_trimestrals.create'),
              ...
              <td class="ls-txt-right ls-regroup">
                <div class="ls-dropdown ls-pos-right" data-ls-module="dropdown">
                  ...
                  <ul class="ls-dropdown-nav" aria-hidden="true">
                    <li><a href="{{ route('admin.b_trimestrals.attachments.index', $bidding->id) }}">Anexos</a></li>
                    <li>@include('elements.admin.shared.edit_button', ['route' => route('admin.b_trimestrals.edit', $bidding->id)])</li>
                    <li>@include('elements.admin.shared.delete_button', ['route' => route('admin.b_trimestrals.destroy', $bidding->id)])</li>
                  </ul>
                </div>
              </td>
            </tr>
